...
class TestRallyAlgorithm(unittest.TestCase):
    def setUp(self):
        self.operator_list = [Operator.ADDITION, Operator.SUBTRACTION, Operator.MULTIPLICATION, Operator.DIVISION]
        self.min_value = 1
        self.max_value = 100
    ...
    def test_initialization(self):
        algorithm = RallyAlgorithm(self.operator_list, self.min_value, self.max_value, self.num_operators, self.rand_seed)
    ...
    def test_build_rally(self):
        ...
        self.assertEqual(len(algorithm.result), self.num_operators + 1)  # Includes the starting value
    ...
    def test_choice_criterium(self):
        ...
        self.assertFalse(algorithm.choice_criterium(0, Operator.SUBTRACTION, 60, results))
        self.assertFalse(algorithm.choice_criterium(101, Operator.ADDITION, 51, results))
